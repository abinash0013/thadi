...
<?php 
    $cId = $_GET['id'];
    $resultdata = $con->query("SELECT * FROM `tbl_mainOfferProduct` WHERE mainOfferProductId = '$cId'");
    $result = array();
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-ml-8 col-mdl-4 col-sm-6 mt-5">
                                ...
                                <div class="alert alert-success alert-dismissible fade show" role="alert" id="successmessage" style="display:none">
                                    You had <strong>Successfully Edit</strong>a New  Offer Product
                                    ...
                                    <form action="#" method="post" id='dataform'>
                                        <div class="pricing-list">
                                            ...
                                            <div class="prc-list text-left">
                                                ...
                                                <input type="hidden" name="mainOfferProductId" value="<?php echo $value['mainOfferProductId'];?>"/>
                                                <div class="row">
                                                    <div class="col-md-3">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="col font-weight-bold">
                                                            <input type="text" class="form-control form-control-sm myform" name="title" value="<?php echo $value['title']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="col font-weight-bold">
                                                            <input type="text" class="form-control form-control-sm myform" name="price" value="<?php echo $value['price']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="col font-weight-bold">
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <div class="custom-file">
                                                                    ...
                                                                    <input type="hidden" class="custom-file-input" name="imageurl" value="<?php echo $value['image']; ?>">
                                                                    <input type="file" class="custom-file-input" name="image" value="<?php echo $value['image']; ?>">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="col font-weight-bold">
                                                            <!--<textarea class="form-control" name="description" value="<?php echo $value['description']; ?>"></textarea>-->
                                                            <textarea class="form-control" name="description" ><?php echo $value['description']; ?></textarea>
                                                            <!--<input type="text" class="form-control form-control-sm myform" name="singleItemPrice" value="<?php echo $value['description']; ?>">-->
                                                        </div>
                                                    </div>
