...
<?php 
    $cId = $_GET['id'];
    $resultdata = $con->query("SELECT * FROM `tbl_category` WHERE categoryId = '$cId'");
    $result = array();
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-ml-8 col-mdl-4 col-sm-6 mt-5">
                                ...
                                <div class="alert alert-success alert-dismissible fade show" role="alert" id="successmessage" style="display:none">
                                    <strong>Edt Successfully</strong>
                                        ...
                                        <div class="pricing-list">
                                            ...
                                            <div class="prc-list text-left">
                                                ...
                                                <input type="hidden" name="categoryId" value="<?php echo $value['categoryId'];?>"/>
                                                 <input type="hidden" name ="imageurl" value="<?php echo $value['categoryImage'];?>"/>
                                                <div class="row">
                                                    <div class="col-md-3">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="col font-weight-bold">
                                                            <input type="text" class="form-control form-control-sm myform" name="categoryName" value="<?php echo $value['categoryName']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="col font-weight-bold">
                                                            <input type="number" class="form-control form-control-sm myform" name="singleItemPrice" value="<?php echo $value['singleItemPrice']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="col font-weight-bold">
                                                            <div class="input-group mb-3">
                                                                <div class="input-group-prepend">
                                                                    <img src="<?php echo $value['categoryImage'];?>" style="height:50px; width:50px;"/>
                                                                </div>
