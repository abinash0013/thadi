<?php
    ...
    if(!empty($data->categoryType)){  
        ...
        $offer->categoryType = $data->categoryType;
       // $offer->categoryId = $data->title;
        
        // query products
            $stmt = $offer->tbl_mainOfferProduct();
            $num = $stmt->rowCount();
            ...
            echo json_encode(array("status" => "200" ,"message" => "Data Found" , "data" => $offer_arr));
            }else{
